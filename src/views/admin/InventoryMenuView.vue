                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end justify-content-center">
                                        <RouterLink to="/admin/inventory/tambahinventory"
                                            class="btn btn-primary rounded-pill font-weight-semibold" style="height: 40px;">
                                            Tambah Inventory</RouterLink>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                        ...
                                        <tbody>
                                            <template v-for="(inventory, index) in paginatedData">
                                                <tr>
                                                    ...
                                                    <template v-else-if="inventory.status == 'disewa'">
                                                        <td>
                                                            <div class="d-flex justify-content-center align-items-center">
